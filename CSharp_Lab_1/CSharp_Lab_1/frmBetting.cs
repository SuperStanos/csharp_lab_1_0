...
namespace CSharp_Lab_1
{
    public partial class frmBetting : Form
    {
        ...
        {            
            ...
            {
                MessageBox.Show("You must choose at least one guy to place a bet.", Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            ...
            {
                MessageBox.Show("You can't bet more than 15 dollars.", Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
